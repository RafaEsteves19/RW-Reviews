    ...
    return (
        ...
        <>
            ...
            <Helmet>
                ...
                <title translate="no">Sobre - RW Reviews</title>

                <meta translate="no"
                    name="description"
                    content="Conheça a proposta do RW Reviews."
                />
            ...
            <main className="about-page">
                ...
                >
                    ...
                    <h1 translate="no">Sobre o RW Reviews</h1>

                    <p style={{ color: '#9a9999' }}>

                        O <strong translate="no">RW Reviews</strong> foi criado com um
                ...
                <section className="about-section transparency">
                    ...
                    <p>
                        ...
                        O <spam translate="no">RW Reviews</spam> utiliza links de afiliados para
